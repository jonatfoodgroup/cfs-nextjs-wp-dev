        ...
        <Row className="justify-content-md-center">
          <Col md={5}>
            <img
              ...
              className="img-fluid"
            />
              <p style={{marginTop: 10}}>Autmn Harvest Salad Made with Campbell's Signature Harvest Butternut Squash</p>
          ...
          <Col md={5}>
            <Row>
              <Col md={6}>
                ...
                <p style={{fontSize: '.8rem', marginTop: 8}}>“Creamy” Tomato Basil Soup Made with Campbell’s® Condensed Tomato Soup</p>
              </Col>
              ...
              <Col md={6}>
                <img
                  ...
                  className="img-fluid"
                />
                <p style={{fontSize: '.8rem', marginTop: 8}}>Sauteed Onion & Mushroom Gravy Made with Campbell’s® Signature Sauteed Onion & Mushroom Bisque</p>
              </Col>
              <Col md={6}>
                <img
                  ...
                  className="img-fluid"
                />
                <p style={{fontSize: '.8rem', marginTop: 8}}>Pasta with Creamy Tomato Vodka Sauce Made</p>
              </Col>
              ...
              <Col md={6}>
                <img
                  ...
                  className="img-fluid"
                />
                <p style={{fontSize: '.8rem', marginTop: 8}}>Jerk Chick With Watermelon Salsa</p>
              </Col>
            </Row>
          </Col>
        </Row>
