...
export function HomeRecipeBlock({link, icon, alttext, sectionCopy, linkCopy}) {
                ...
                <Container>
                    ...
                    <Row className="justify-content-md-center">
                      ...
                      {/* Large featured recipe  */}  
                            <img src="https://via.placeholder.com/650x650" className="img-fluid" />
                        <h5>Title</h5>
                        <p> description</p>
                        </Col>
                        <Col md={5}>
                            <Row>
                                <Col md={6}>
                                    <img src="https://via.placeholder.com/300x300" className="img-fluid" />
                                    <h5>Title</h5>
                                </Col>
